...
- **What**: Allows users to initiate conversations with other users or join group conversations.  
- **Why**: Enables users to expand their network, join group discussions, and create new chat threads without navigating through complex menus.  
- **Result**: Your app will provide an intuitive interface for users to discover and connect with other users, join groups, and start new conversations with proper navigation and state management.  
...
- Handle group join errors gracefully  
