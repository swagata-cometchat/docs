...
<!-- themes.xml -->
<style name="CustomCometChatMessageListStyle" parent="CometChatMessageListStyle">
    <item name="cometchatMessageListIncomingMessageBubbleStyle">@style/CustomIncomingBubbleStyle</item>
</style>

<style name="CustomIncomingBubbleStyle" parent="CometChatIncomingMessageBubbleStyle">
    <item name="cometchatAIAssistantBubbleStyle">@style/CustomAIAssistantBubbleStyle</item>
</style>

<style name="CustomAIAssistantBubbleStyle">
        <item name="cometChatAIAssistantBubbleTextAppearance"></item>
        <item name="cometChatAIAssistantBubbleTextColor"></item>
        <item name="cometChatAIAssistantBubbleBackgroundColor"></item>
        <item name="cometchatAIAssistantBubbleAvatarStyle"></item>
</style>
```
