...
`AI Assistant Chat History` is a [Composite Widget](/ui-kit/flutter/components-overview#composite-components) that displays a list of ai assistant chat history.
