...
Elevate your ai assistant chat history experience with customizable chat history styles.
...
ThemeData(
    extensions: [
          CometChatAiAssistantChatHistoryStyle(
            ...
            headerBackgroundColor: Color(0xFFF76808),
            ...
            newChatIconColor: Color(0xFFF76808),
            newChatTextColor: Color(0xFFF76808),
            newChaTitleStyle: TextStyle(
              fontSize: 16,
              fontWeight: FontWeight.w600,
            ),
          ),
