/*
  CometChat Docs - Product Selector Dropdown (global runtime)
  - Injects a UI Kits–style product dropdown button next to the logo on product/shared pages.
  - Options:
      ...
      Insights -> /insights
  - SPA/hydration-safe; separate from version aligner logic.
  - Note: This runtime purposely does NOT render on the homepage; the homepage-only
          variant lives in /snippets/home-product-dropdown.js.
*/
(function () {
  try {
    ...
    function shouldDisplay(path) {
      // Show within product sections and on shared routes; not on homepage
