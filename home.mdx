...
<Card
  ...
  icon="react"
  iconType="solid"
  href="/ui-kit/react-native/overview"
  horizontal
/>
...
<Card
  title="CometChat Solutions Office Hours"
  icon="briefcase"
  iconType="solid" 
