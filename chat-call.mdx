...
<div style={{maxWidth: '70rem', marginLeft: 'auto', marginRight: 'auto', paddingLeft: '1.25rem', paddingRight: '1.25rem' }}> 
  <Columns cols={2} className="items-center gap-x-12">
    <div className="flex flex-col justify-center h-full text-center md:text-left">
      <h1 className="text-gray-700 dark:text-white" style={{ fontSize: '2.2rem', fontWeight: '600' }}>Chat & Calling</h1>
...
{/* <Accordion title="Get a fully functional chat interface in minutes. Configure via our chat builder—no complex setup required."> */}
  ...
  <CardGroup cols={4}>
    <Card title="React" icon={<img src="/images/icons/react.svg" alt="React" />} href="/chat-builder/react/overview" horizontal />
    <Card title="Next.js" icon={<img src="/images/icons/nextjs.svg" alt="Next.js" />} href="/chat-builder/nextjs/overview" horizontal />
    <Card title="React Router" icon={<img src="/images/icons/react-router.svg" alt="React Router" />} href="/chat-builder/react-router/overview" horizontal />
...
<div className="mb-12">
  ...
  <Card
    title="Squarespace"
    icon={<img src="/images/icons/squarespace.svg" alt="Squarespace" />}
    href="/widget/squarespace/integration"
    horizontal
  />
  <Card
    title="Wix"
    icon={<img src="/images/icons/wix.svg" alt="Wix" />}
    href="/widget/wix/integration"
    horizontal
  />
  <Card
    title="Webflow"
    icon={<img src="/images/icons/webflow.svg" alt="Webflow" />}
