...
<div className="mb-12">
  ...
  <Card
    title="WordPress"
    icon={<img src="/docs/images/icons/wordpress.svg" alt="WordPress" />}
    href="/widget/wordpress/integration"
    horizontal
  />
  <Card
    title="Squarespace"
    icon={<img src="/docs/images/icons/squarespace.svg" alt="Squarespace" />}
    href="/widget/squarespace/integration"
    horizontal
  />
  <Card
    title="Wix"
    icon={<img src="/docs/images/icons/wix.svg" alt="Wix" />}
    href="/widget/wix/integration"
    horizontal
  />
  <Card
    title="Webflow"
    icon={<img src="/docs/images/icons/webflow.svg" alt="Webflow" />}
