...
- Option 1 (recommended): Integrate via Gradle plugin — full customization with generated settings.
  See: [Integration via Gradle plugin](/chat-builder/android/integration#integration-with-cometchat-chat-builder-android)
- Option 2: Import the preconfigured sample app as a module for a plug‑and‑play start.
  See: [Import the sample module](/chat-builder/android/integration#alternative-import-the-sample-app-as-a-module)
