...
- Option 2 (recommended): Integrate via Gradle plugin — full customization with generated settings.
  See: /chat-builder/android/integration#integration-with-cometchat-chat-builder-android
- Option 1: Import the preconfigured sample app as a module for a plug‑and‑play start.
  See: /chat-builder/android/integration#alternative-import-the-sample-app-as-a-module
