...
- *Load settings via Builder (recommended): Use the CometChatBuilder package and load settings via JSON or live QR sync.
  ...
  [Option 1: Load from JSON (no-code)](/chat-builder/ios/integration#option-1-load-from-json-no-code),
  [Option 2: Load via QR Code (live Builder sync)](/chat-builder/ios/integration#option-2-load-via-qr-code-live-builder-sync)
