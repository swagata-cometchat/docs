...
See: [Install the Builder package](/chat-builder/ios/integration#install-the-builder-package),

<CardGroup cols={2}>
  <Card
    title="Option 1: Load from JSON (no-code)"
    href="/chat-builder/ios/integration#option-1-load-from-json-no-code"
    description="Configure settings quickly by importing a JSON file, no coding required."
    horizontal
  >
  ...
  <Card
    title="Option 2: Load via QR Code (live Builder sync)"
    href="/chat-builder/ios/integration#option-2-load-via-qr-code-live-builder-sync"
    horizontal
  >
