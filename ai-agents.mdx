  ...
  <Steps className="mt-6">
    ...
    <p className="text-gray-600 dark:text-gray-300">Start by linking your AI builders. Choose from popular platforms (OpenAI, Mastra, LangGraph and many more..)</p>
      ...
      <CardGroup cols={4} className="mt-4">
        <Card title="Mastra" icon={<img src="/images/icons/mastra.svg" alt="Mastra" />} href="/ai-agents/mastra" horizontal />
        <Card title="LangGraph" icon={<img src="/images/icons/lang-graph.svg" alt="LangGraph" />} horizontal>Coming Soon</Card>
        <Card title="Agno" icon={<img src="/images/icons/agno.svg" alt="Agno" />} horizontal>Coming Soon</Card>
        <Card title="CrewAI Flows" icon={<img src="/images/icons/crew-ai.svg" alt="CrewAI Flows" />} horizontal>Coming Soon</Card>
      </CardGroup>
    ...
    <Step title="Add to your frontend" description="Choose no‑code widget, prebuilt components, or headless SDK.">
      ...
      <CardGroup cols={3} className="mt-4">
        <Card title="No Code - Widget" icon={<img src="/images/icons/ai-agents.svg" alt="Widget" />} description="No‑code" href="/ai-agents/chat-widget" horizontal />
        <Card title="React UI Kit" icon={<img src="/images/icons/react.svg" alt="React" />} href="https://www.cometchat.com/docs/ui-kit/react/ai-assistant-chat" horizontal>Pre Built UI Components</Card>
        <Card title="JavaScript SDK" icon={<img src="/images/icons/js.svg" alt="JavaScript SDK" />} horizontal>Coming Soon</Card>
      </CardGroup>
      <CardGroup cols={3} className="mt-4">
        <Card title="React Native" icon={<img src="/images/icons/react.svg" alt="React Native" />} horizontal>Coming Soon</Card>
        <Card title="Android" icon={<img src="/images/icons/android.svg" alt="Android" />} horizontal>Coming Soon</Card>
        <Card title="iOS Swift" icon={<img src="/images/icons/swift.svg" alt="iOS Swift" />} horizontal>Coming Soon</Card>
      </CardGroup>
      <CardGroup cols={3} className="mt-4">
        <Card title="Flutter" icon={<img src="/images/icons/flutter.svg" alt="Flutter" />} horizontal>Coming Soon</Card>
      </CardGroup>
    </Step>
